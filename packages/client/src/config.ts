...
import { DEFAULT_LM_STUDIO_HOST, DEFAULT_LM_STUDIO_PORT } from '@lmstudio-proxy/common';
...
export const config: ClientConfig = {
  // Remote server configuration
  remoteServerUrl: process.env.REMOTE_SERVER_URL || 'wss://api.example.com/proxy',
  apiKey: process.env.API_KEY || '',
  clientId: process.env.CLIENT_ID || '',

  // Local LM Studio configuration
  lmStudioHost: process.env.LM_STUDIO_HOST || DEFAULT_LM_STUDIO_HOST,
  lmStudioPort: parseInt(process.env.LM_STUDIO_PORT || String(DEFAULT_LM_STUDIO_PORT)),
